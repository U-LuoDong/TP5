...
//		require '/StudentInformationManagementSystem/denfence.php';//引入安全保护类
		require '/static/admin/sphinxapi.php';
//		require 'http://localhost/tp5/public/static/admin/sphinxapi.php';
//		require 'http://127.0.0.1/tp5/public/static/admin/sphinxapi.php';
		die;
	}
    public function lst()
    {   
